...
namespace BattleSimulator.UI
{
    public class UIListItem : MonoBehaviour, IPointerDownHandler, IPointerClickHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public event Action<UIListItem, PointerEventData> onDragBegin;
        public event Action<UIListItem, PointerEventData> onDrag;
        public event Action<UIListItem, PointerEventData> onDragEnd;
